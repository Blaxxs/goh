...
const String miniontauros3starPiece =
    'tauros_3star_piece'; // '타우로스 3성 조각'의 영문명 기반 ID
const String miniontauros4starPiece =
    'tauros_4star_piece'; // '타우로스 4성 조각'의 영문명 기반 ID
const String miniontauros5starPiece =
    'tauros_5star_piece'; // '타우로스 5성 조각'의 영문명 기반 ID
const String miniontauros6starPiece =
    'tauros_6star_piece'; // '타우로스 6성 조각'의 영문명 기반 ID

const String accessoryOlympusLaurelWreath =
    'olympus_laurel_wreath'; // '올림포스 월계관'의 영문명 기반 ID

const String borrowedPowerjokernormal = 'joker_normal'; //차력 조커 노말

const String fragmentminigamedamagenormal =
    'minigame_damage_normal'; // 미니게임 파편 노말
const String fragmentminigamedamageadvanced =
    'minigame_damage_advanced'; // 미니게임 파편 고급
