...
class AppSettingsScreenUI extends StatelessWidget {
  ...
  Widget _buildInfoTile(
    ...
    return ListTile(
      ...
      subtitle: Text(
        // 이메일의 경우에도 subtitle은 Text로 표시하고, 탭 액션으로 복사
        subtitle,
        // ignore: deprecated_member_use
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('작은 글씨 예시입니다. (Body Small)',
                      style: theme.textTheme.bodySmall),
                  const SizedBox(height: 8),
                  Text('중간 크기 글씨 예시입니다. 가나다라 ABC 123 (Body Medium)',
                      style: theme.textTheme.bodyMedium),
                  const SizedBox(height: 8),
                  Text('큰 글씨 예시입니다. 설정 및 제목 등 (Title Medium)',
                      style: theme.textTheme.titleMedium),
                  const SizedBox(height: 8),
                  Text('더 큰 제목 예시입니다. (Title Large)',
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Text(
                      ...
                      style: theme.textTheme.titleLarge?.copyWith(
                        ...
                        color: theme.colorScheme
                            .secondary, // "앱 정보" 제목 색상을 Secondary 색상으로 변경
                      ),
                    ),
                  ),
                  _buildInfoTile(
                    ...
                    title: '도움 주신 분들',
                    subtitle:
                        '세계는스몰 님, PDL힉센 님, 貪민서 님, Hebi 님, 뮤즈 님, Fractal 님, 뽀짝 님, 공명 님 ,貪벨리알 님, 모리님, 기타 많은 분들...',
                  ),
                  ...
                  _buildInfoTile(
                    ...
                    context,
                    icon: Icons
                        .chat_bubble_outline_rounded, // 카카오톡 유사 아이콘 또는 다른 적절한 아이콘
                    title: '카카오톡 문의',
