...
class _NewSwitchStyleToggleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double requiredRowWidth = iconWidth +
        spacingBetweenIconText +
        textWidth +
        spacingBetweenTextSwitch +
        switchEffectiveWidth;
      ...
      builder: (context, constraints) {
        ...
        if (shouldChangeLayout) {
          ...
          return Column(
            ...
            crossAxisAlignment:
                CrossAxisAlignment.center, // Column 내용을 가로 중앙 정렬
            mainAxisSize: MainAxisSize.min,
            children: [
              Row(
                mainAxisAlignment:
                    MainAxisAlignment.center, // 아이콘과 텍스트를 가로 중앙 정렬
                mainAxisSize: MainAxisSize.min,
                children: [
                  iconWidget,
              ...
              Flexible(
                ...
                child: Text(
                  ...
                  overflow: TextOverflow
                      .ellipsis, // Fallback if Row is forced and too narrow
                  softWrap: false,
                  maxLines: 1,
                ),
              ),
...
class CalculatorScreenUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double defaultHeaderFontSize =
            ...
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(
                ...
                title: Text(
                  ...
                  style: TextStyle(
                    fontSize:
                        (theme.textTheme.titleMedium?.fontSize ?? 16.0) + 2.0,
                    color: theme.textTheme.titleMedium?.color ??
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Center(
                                // 각 토글을 Center 위젯으로 감싸서 셀 내에서 가운데 정렬
                                child: _NewSwitchStyleToggleWidget(
                                    value: expHotTime,
                                    onChanged: onExpHotTimeChanged,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Center(
                                child: _NewSwitchStyleToggleWidget(
                                    value: reverseElement,
                                    onChanged: onReverseElementChanged,
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2<String>(
                            ...
                            selectedItemBuilder: (context) => leaderList
                                .map((item) => Container(
                      ...
                      Expanded(
                        child: Stack(
                          clipBehavior:
                              Clip.none, // 텍스트가 Stack 경계를 넘어서도 보이도록 설정
                          ...
                          children: [
                              ...
                              child: DropdownButton2<String>(
                                ...
                                buttonStyleData: ButtonStyleData(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(8),
                                        border: Border.all(
                                          color: selectedMonsterName == null
                                              ? Colors.red
                            ...
                            if (selectedMonsterName == null)
                              Positioned(
                                ...
                                child: Container(
                                  // 텍스트 배경색 및 패딩을 위해 Container 사용 (선택 사항)
                                  padding: const EdgeInsets.symmetric(
                              ...
                              child: DropdownButton2<String>(
                                ...
                                buttonStyleData: ButtonStyleData(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(8),
                                        border: Border.all(
                                          color: selectedMonsterGrade == null
                                              ? Colors.red
                                              : Colors.grey.shade400,
                                        ),
                                        color: theme.inputDecorationTheme
                                ...
                                selectedItemBuilder: (context) =>
                                    monsterGradeList
                                        .where((g) => !((selectedMonsterName ==
                                                    '까마귀' ||
                                                selectedMonsterName == '요원') &&
                                            g == '6성'))
                                        .map((item) => Container(
                                            alignment: Alignment.center,
                                            child: FittedBox(
                        ...
                        DropdownButtonHideUnderline(
                          child: DropdownButton2<CalculatorSortOption>(
                            ...
                            items: CalculatorSortOption.values
                                .map((option) =>
                                    DropdownMenuItem<CalculatorSortOption>(
                                      value: option,
                                      child: Text(
                                ...
                                child: Center(
                                  child: FittedBox(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text('루프 시간',
                                            style: headerColumnClickableTextStyle
                                                .copyWith(
                                                    fontSize:
                                                        headerColumnClickableTextStyle
                                                                .fontSize! *
                                                            0.75),
                                            softWrap: false),
                                        const SizedBox(
                                            width:
                                                2), // 아이콘과의 간격 조정 (이전에 2였던 것을 16으로 넓힘)
              ...
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  (BuildContext context, int index) {
                    // 필터링된 스테이지 목록 생성
                    final List<StageDisplayData> displayedStageResults =
                        hideUnconfiguredStages
                            ? stageResults
                                .where((data) => !data.settingsIncomplete)
                                .toList()
                            : stageResults;

                    final data = displayedStageResults[index];
                    final double? currentSoulStoneValue =
                        showSoulStonesPerMinute
                    ...
                    TextStyle soulStoneStyle = TextStyle(
                      fontSize:
                          (theme.textTheme.bodyMedium?.fontSize ?? 14.0) * 0.75,
                      color: colorScheme.onSurface,
                    );
                    ...
                    if (currentSoulStoneValue != null) {
                      if (currentSoulStoneValue < 0) {
                        soulStoneStyle =
                            soulStoneStyle.copyWith(color: Colors.blue);
                      } else if (maxPositiveSoulStoneValue != null &&
                          currentSoulStoneValue > 0 &&
                          currentSoulStoneValue == maxPositiveSoulStoneValue) {
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              flex: 3,
                              child: InkWell(
                                // settingsIncomplete가 false일 때만 InkWell
                            ...
                            const VerticalDivider(
                                width: 1,
                                thickness: 1,
                                color: Color.fromARGB(132, 202, 202, 202)),
                            Expanded(
                                flex: 3,
                                child: Padding(
                                    padding: const EdgeInsets.symmetric(
                  ...
                  childCount: hideUnconfiguredStages
                      ? stageResults
                          .where((data) => !data.settingsIncomplete)
                          .length
                      : stageResults.length,
