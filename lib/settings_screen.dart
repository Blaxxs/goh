...
// 필요한 상수 파일 직접 import
import 'constants/stage_constants.dart'; // stageList 사용 (정확히는 stageNameList getter)

import 'presentation/settings/settings_screen_ui.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  @override
  void dispose() {
    // 화면이 소멸될 때 현재 입력된 정보로 설정을 자동으로 저장합니다.
    // 현재 _saveSettings 함수는 컨트롤러의 text 값을 그대로 사용하며,
    // SettingsService의 fromJson 등에서 타입 변환 시 오류 처리가 중요합니다.
    _saveSettings(showSnackbar: false); // 자동 저장 시에는 SnackBar를 표시하지 않음
